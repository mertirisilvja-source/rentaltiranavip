    ...
    <main className="min-h-screen bg-black pt-24 pb-16 text-white">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/80">
          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.rental.title")}</h2>
            <p className="mt-2">{t("terms.rental.body")}</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.requirements.title")}</h2>
            <p className="mt-2">{t("terms.requirements.body")}</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.payment.title")}</h2>
            <p className="mt-2">{t("terms.payment.body")}</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.deposit.title")}</h2>
            <p className="mt-2">{t("terms.deposit.body")}</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.cancellation.title")}</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.liability.title")}</h2>
            <p className="mt-2">{t("terms.liability.body")}</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white">{t("terms.contact.title")}</h2>
