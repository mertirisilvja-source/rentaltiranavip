...
export default function AvailableCarsPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-black pt-24 pb-16">
      <div className="mx-auto w-full max-w-7xl px-4">
        {hasReservation && (
          <div className="mb-8 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-4 text-sm text-gray-700 dark:text-white/80">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div className="text-gray-700 dark:text-white/80">
                ...
                {pickupLocation} <span className="text-gray-400 dark:text-white/50">•</span>{" "}
                <span className="text-gray-400 dark:text-white/50">
              ...
              <div className="text-gray-500 dark:text-white/70">
                ...
                <span className="text-gray-400 dark:text-white/50">→</span> {dropoffDate}{" "}
                {dropoffTime}
              </div>
            </div>
          </div>
        ...
        {loading ? (
          <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-6 text-gray-500 dark:text-white/70">
            Loading cars...
          </div>
        ) : error ? (
